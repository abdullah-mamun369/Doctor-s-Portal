        ...
        <div className='h-screen w-screen flex justify-center items-center '>
            <div className='shadow-xl p-10 rounded-md lg:w-3/12 w-full mx-5 mt-5'>
                ...
                <form className='grid gap-6' onSubmit={handleSubmit(handleLogin)}>
                    ...
                    {/* <p>{data}</p> */}
                    <button className='btn bg-accent text-white w-full'>Login</button>
                    <p className='text-center font-semibold'>New to Doctors Portal? <Link to='/signup' className='text-secondary'> Create new account</Link> </p>
                    <div className="divider">OR</div>

                </form>
                <button className='btn btn-outline btn-accent text-white w-full'>Continue with google</button>
            </div>
        </div>
