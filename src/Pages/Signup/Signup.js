        ...
        <div className='h-screen w-screen flex justify-center items-center'>
            <div className='shadow-xl p-10 rounded-md lg:w-3/12 w-full mx-5 mt-5'>
                ...
                <form className='grid gap-6' onSubmit={handleSubmit(handleSignUp)}>
                    ...
                    {/* <p>{data}</p> */}
                    <button className='btn bg-accent text-white w-full'>Sign Up</button>
                    <p className='text-center font-semibold'>Already have an account? <Link to='/login' className='text-secondary'>Login</Link> </p>
